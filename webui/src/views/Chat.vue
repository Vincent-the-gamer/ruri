  ...
  <div class="chat-view">
    ...
    <header class="chat-header glass">
      ...
      <div class="header-right">
        ...
        <div v-if="providerStore.activeProvider" class="model-badge">
          ...
          <span>{{
            (providerStore.activeProvider.config as any)?.default_model
          }}</span>
        </div>
        <div
    ...
    <div ref="messagesContainer" class="messages-area">
      <div class="messages-inner">
        ...
        <!-- Chat Messages -->
        <ChatMessageComp v-for="(msg, i) in messages" :key="i" :message="msg" />
        ...
        <div v-if="chatStore.loading" class="thinking-message">
          <div class="thinking-avatar">
            <svg class="avatar-icon" viewBox="0 0 24 24" fill="none">
              ...
              />
              <path d="M12 2 L16 8 L12 6 L8 8 Z" fill="rgba(255,255,255,0.4)" />
            </svg>
