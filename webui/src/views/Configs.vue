  ...
  <div class="page">
    ...
    <div v-else class="card-list">
      <div
        ...
        :key="config.id"
        :class="['config-card', { 'config-card--active': config.is_active }]"
        :style="{ animationDelay: `${index * 0.05}s` }"
      >
        <div v-if="config.is_active" class="card-glow card-glow--active"></div>
          ...
          <div class="card-info">
            <div class="card-icon">
              <span class="icon-wrapper">
                <Icon
                  :icon="
                    config.is_active ? 'lucide:check-circle' : 'lucide:settings'
                  "
                />
              </span>
              <span
            ...
            <div class="card-details">
              ...
              <div class="card-meta">
                ...
                <div class="card-tags">
                  <span v-if="config.web_search_enabled" class="tag">Web</span>
                  <span v-if="config.computer_use_enabled" class="tag"
                    >Computer</span
                  >
                  <span v-if="config.acp_enabled" class="tag">ACP</span>
                  <span v-if="config.active_skill_names.length > 0" class="tag">
