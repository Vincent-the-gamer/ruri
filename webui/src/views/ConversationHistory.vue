...
<template>
  <div class="conversation-history-view">
    <!-- 头部 -->
    <div class="header">
      <h1 class="title">{{ t('conversationHistory.title') }}</h1>
      <p class="subtitle">{{ t('conversationHistory.subtitle') }}</p>
    </div>

    <!-- 筛选工具栏 -->
    <div class="filter-toolbar">
      <div class="filter-item">
        <label for="bot-name">{{ t('conversationHistory.botName') }}</label>
        <input
          id="bot-name"
      ...
      <div class="filter-item">
        <label for="chat-type">{{ t('conversationHistory.chatType') }}</label>
        <select id="chat-type" v-model="filter.chat_type" @change="applyFilter">
          <option
      ...
      <div class="filter-item">
        <label for="keyword">{{ t('conversationHistory.keyword') }}</label>
        <input
          id="keyword"
      ...
      <table class="conversations-table">
        ...
        <tbody>
          <tr v-for="conversation in conversations" :key="conversation.id">
            <td class="title-cell">
              {{ conversation.title || t('conversationHistory.noTitle') }}
            </td>
