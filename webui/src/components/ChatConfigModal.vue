...
<template>
    <Transition name="modal">
        <div v-if="modelValue" class="modal-backdrop" @click="onOverlayClick">
            <div class="modal-card">
                ...
                <div class="modal-body">
                    ...
                    <section class="config-section">
                        ...
                        <div
                            v-if="activeProviderForChat"
                            class="provider-preview"
                        >
                            <div class="provider-preview-header">
                                <span class="provider-preview-name">{{
                                    activeProviderForChat.name
                                }}</span>
                                <span class="provider-preview-model">{{
                                    (activeProviderForChat.config as any)
                                        .default_model
                                }}</span>
                            </div>
                        </div>
                    ...
                    <section class="config-section">
                        ...
                        <div v-if="knowledgeBases.length > 0" class="kb-grid">
                            <div
                                ...
                                class="kb-card"
                                :class="{
                                    'kb-card--selected': selectedKbIds.includes(
                                        kb.id,
                                    ),
                                }"
                        ...
                        <Transition name="proxy-slide">
                            ...
                            >
                                ...
                                <div class="form-field">
                                    ...
                                    <div
                                        v-if="
                                            proxyConfig.bypass_domains.length >
                                            0
                                        "
                                        class="tag-list"
                                    >
